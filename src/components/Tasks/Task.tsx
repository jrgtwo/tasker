        ...
        (!task || taskError)
          ...
          : (
              <>
                ...
                <button
                  className="items-center mt-6 gap-4 flex flex-row hover:cursor-pointer text-nowrap outline-1 hover:outline-2 outline-white/20 w-min px-6 py-2 rounded-lg outline-offset-1">
